/**
 * firestoreService.js — универсальный CRUD для Firestore
 * Отвечает за: getCollection, getDocument, addDocument, setDocument (документ с заданным id),
 * updateDocument, deleteDocument для любых коллекций (products, sales, suppliers, users)
 */
...
/** Создать или перезаписать документ с заданным ID (например, users/{uid}) */
